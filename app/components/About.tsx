const About = () => {
  return (
    <div id="about" className="w-full rounded-r-full py-16 bg-primary/5">
      <section
      ...
      >
        <h2
          id="about-heading"
          className="font-heading text-xl sm:text-2xl md:text-3xl font-medium md:text-center italic mb-8"
        >
          About <span className="text-primary">Jay Decor</span>
        </h2>

        <p className="text-sm sm:text-base mt-4 md:text-center max-w-2xl mx-auto">
          Welcome to JAY DECOR, your ultimate one-stop solution for interior and
          exterior design needs.
        </p>
        <p className="font-normal text-sm sm:text-base leading-relaxed my-4 md:text-center max-w-3xl mx-auto">
