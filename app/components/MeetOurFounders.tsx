    ...
    >
      <div className="w-[90%] md:w-3/4 mx-auto">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-medium text-center mb-8">
          Meet Our{" "}
          <span className="text-primary bg-white px-3 rounded-2xl not-italic">
            Founder
          </span>
        </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-16 items-center md:items-start py-6 md:py-10 px-4 xl:px-24">
          ...
          <div className="leading-relaxed flex flex-col gap-3 sm:text-center md:text-left">
            ...
            <p className="text-secondary text-sm sm:text-base">
              With over{" "}
              <span className="bg-white px-3 py-0.5 rounded-2xl font-medium">
                20 years of industry experience
              </span>{" "}
              Yatish Arekar founded JAY DECOR with a simple vision — to make
            ...
            <p className="text-secondary text-sm sm:text-base tracking-wide">
              ...
              <span className="bg-white px-3 py-0.5 font-medium rounded-2xl">
                transparency, quality, and customer satisfaction
              </span>{" "}
              have helped JAY DECOR build lasting relationships across
            ...
            <p className="w-fit text-secondary bg-white px-4 py-1 rounded-r-2xl text-sm sm:text-base tracking-wide font-medium">
